...
import { ChevronDown, ChevronRight, ChevronLeft, Mail, Shield, FileText, Cookie } from "lucide-react"
                ...
                >
                  ...
                  <div
                    className={cn(
                      ...
                      desktopMenuExpanded
                        ? "w-12 h-12 sm:w-14 sm:h-14 md:w-12 h-12"
                        : "w-8 h-8 sm:w-9 sm:h-9 md:w-8 h-8",
                    )}
                  >
                    <OptimizedImage
                      ...
                      className={cn(
                        ...
                        desktopMenuExpanded
                          ? "w-10 h-10 sm:w-12 sm:h-12 md:w-10 h-10 opacity-100"
                          : "w-6 h-6 sm:w-7 sm:h-7 md:w-6 h-6 opacity-60",
                      )}
                      style={{
                        objectFit: "contain",
