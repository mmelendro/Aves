      ...
      <DialogContent className="w-[95vw] max-w-md sm:max-w-lg max-h-[90vh] overflow-y-auto p-4 sm:p-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full grid-cols-2 h-12 mb-6">
            <TabsTrigger value="signup" className="flex items-center gap-2 text-sm sm:text-base py-2 px-3">
              <UserPlus className="w-4 h-4" />
              <span className="hidden sm:inline">Create Account</span>
              <span className="sm:hidden">Sign Up</span>
            </TabsTrigger>
            <TabsTrigger value="signin" className="flex items-center gap-2 text-sm sm:text-base py-2 px-3">
            ...
            <form onSubmit={handleSignUp} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full h-11 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
                  disabled={loading}
                >
