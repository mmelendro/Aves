...
import { CheckCircle, Clock, Target, Users, Globe, Award } from "lucide-react"
                ...
                <div className="flex items-start space-x-8">
                  ...
                  <div className="flex-1">
                    <div className="bg-white rounded-xl p-8 shadow-xl border-l-4 border-purple-600">
                      <div className="flex items-center mb-6">
                        <Badge className="bg-purple-100 text-purple-800 mr-4 text-sm font-semibold">🎯 Q4 2026</Badge>
                        <h3 className="text-3xl font-bold text-gray-900">Phase 3: Verification & Certification</h3>
                      </div>
                      <p className="text-lg text-gray-600 mb-6">
                        Final assessment, third-party verification, and submission for official B Corp certification.
                        This phase includes rigorous documentation review and site verification processes.
                      </p>
