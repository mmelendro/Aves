...
import { CheckCircle, Clock, Target, Users, Leaf, Globe, Award, ArrowRight, Menu, X, ChevronDown } from "lucide-react"
      ...
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-sm border-b">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Link href="/about/b-corp" className="text-emerald-600 font-medium transition-colors">
              B Corp Journey
            </Link>
