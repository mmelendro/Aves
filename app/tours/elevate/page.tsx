...
import { Users, Calendar, ArrowRight, CheckCircle, Menu, X, ChevronDown, Clock, Award, Mountain } from "lucide-react"
        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <div className="relative group">
              ...
              <div className="absolute top-full left-0 mt-2 w-56 bg-white rounded-lg shadow-lg border opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                ...
                <Link
                  href="/tours/elevate"
                  className="block px-4 py-3 text-yellow-600 font-medium hover:bg-yellow-50 transition-colors"
                >
                  🌼 AVES Elevate
                </Link>
                <Link
          ...
          <div className="hidden md:block">
            <Link href="/shopping?preset=elevate">
              <Button className="bg-yellow-600 hover:bg-yellow-700">Book Your Journey</Button>
            </Link>
          </div>
            ...
            <nav className="container mx-auto px-4 py-4 space-y-4">
              <div className="py-2">
                ...
                <div className="pl-4 space-y-2">
                  ...
                  <Link
                    href="/tours/elevate"
                    className="block text-yellow-600 font-medium transition-colors py-1"
                    onClick={() => setMobileMenuOpen(false)}
                  >
                    🌼 AVES Elevate
                  </Link>
              ...
              <div className="pt-4">
                <Link href="/shopping?preset=elevate">
                  <Button className="w-full bg-yellow-600 hover:bg-yellow-700">Book Your Journey</Button>
                </Link>
              </div>
            </nav>
          </div>
