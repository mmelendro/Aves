...
import { Eye, EyeOff, Mail, Lock, User, AlertCircle, Loader2, Bird, CheckCircle } from "lucide-react"
...
export default function SignupForm() {
  ...
  const birdingExperienceOptions = [
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { error } = await signUp(formData.email, formData.password, {
        ...
        birding_experience: formData.birdingExperience,
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      // Note: Google sign-in will redirect automatically
    } catch (err) {
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 to-blue-50 p-4">
        <Card className="w-full max-w-md shadow-xl border-0">
          <CardContent className="text-center p-8">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Welcome to AVES!</h2>
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 to-blue-50 p-4">
      <Card className="w-full max-w-lg shadow-xl border-0">
        <CardHeader className="text-center pb-6">
          ...
          <CardTitle className="text-2xl font-bold text-gray-900">Join AVES Colombia</CardTitle>
          <CardDescription className="text-gray-600">
            Create your account and start your birding adventure in Colombia
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Birding Experience */}
            <div className="space-y-2">
              <Label htmlFor="birdingExperience" className="text-sm font-medium text-gray-700">
                Birding Experience
              </Label>
              <Select
                value={formData.birdingExperience}
                onValueChange={(value) => handleInputChange("birdingExperience", value)}
                disabled={isLoading}
              >
                ...
                <SelectContent>
                  {birdingExperienceOptions.map((option) => (
            ...
            {/* Preferred Regions */}
            <div className="space-y-2">
              <Label className="text-sm font-medium text-gray-700">Preferred Regions (Optional)</Label>
                ...
                {regionOptions.map((region) => (
                  <div key={region} className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      disabled={isLoading}
                    />
                    <Label htmlFor={region} className="text-xs text-gray-700 cursor-pointer">
                      {region}
                    </Label>
                  </div>
                ))}
