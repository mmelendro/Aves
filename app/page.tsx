...
import { CheckCircle, ArrowRight, Users, Globe, Award, Menu, X, ChevronDown } from "lucide-react"
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            <Badge className="bg-emerald-100 text-emerald-800 hover:bg-emerald-100 mb-6">
              🌿 Premium Colombian Birding Experiences
            </Badge>
            <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 mb-6">
              Discover Colombia's Incredible Bird Diversity
            </h1>
            <p className="text-xl text-gray-600 leading-relaxed mb-8">
              Join AVES for exclusive small-group birding expeditions across Colombia's most biodiverse regions. Every
              tour supports conservation through our innovative Conservation Endowment Trust.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              ...
              <Link href="/tours">
                <Button
                  size="lg"
                  variant="outline"
                  className="border-emerald-600 text-emerald-600 hover:bg-emerald-600 hover:text-white text-lg px-8 py-4"
                >
                  Explore Tours
                </Button>
              </Link>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Our Tour Experiences</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Four distinct birding experiences designed to showcase Colombia's incredible avian diversity while
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              communities through our innovative Conservation Endowment Trust.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card className="text-center p-8 border-0 shadow-lg">
              ...
              <p className="text-gray-600">
                Every tour directly supports habitat protection and community conservation initiatives through our CET.
              </p>
            </Card>
            <Card className="text-center p-8 border-0 shadow-lg">
              <div className="w-16 h-16 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">
                Professional ornithologists and local experts provide unmatched knowledge and cultural insights.
              </p>
            </Card>
          </div>
        </div>
