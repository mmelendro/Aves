          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                <Badge className="text-white border border-white/30 backdrop-blur-sm hover:bg-white/10">
                  🌿 B Corp Certified • Carbon Neutral Tours
                </Badge>
                <h1 className="text-4xl lg:text-6xl font-bold text-white leading-tight drop-shadow-lg">
                  Discover Colombia's
                  <span className="text-emerald-300 block drop-shadow-lg">1,900+ Bird Species</span>
                </h1>
                <div className="backdrop-blur-sm rounded-lg p-4 border border-white/20 shadow-lg">
              ...
              <div className="backdrop-blur-sm rounded-lg p-6 border border-white/20 shadow-lg">
                <div className="grid grid-cols-3 gap-8">
                  <div className="text-center">
                    <div className="text-3xl font-bold text-white drop-shadow-lg">1,900+</div>
                    <div className="text-sm text-white/90 drop-shadow-md">Bird Species</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-white drop-shadow-lg">4</div>
                    <div className="text-sm text-white/90 drop-shadow-md">Max Group Size</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-white drop-shadow-lg">100%</div>
                    <div className="text-sm text-white/90 drop-shadow-md">Carbon Neutral</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="aspect-[4/5] rounded-2xl overflow-hidden shadow-2xl bg-white/5 backdrop-blur-sm border border-white/20 opacity-90">
                <OptimizedImage
              ...
              <div className="absolute -bottom-6 -left-6 backdrop-blur-md rounded-xl p-4 shadow-2xl border border-white/30">
                <a
                  href="https://ebird.org/species/vercar1"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center space-x-3 hover:bg-white/10 transition-colors rounded-lg p-1 -m-1"
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-sm text-white/90 italic drop-shadow-sm">Cardinalis phoeniceus</div>
                    <div className="text-xs text-emerald-300 drop-shadow-sm">
